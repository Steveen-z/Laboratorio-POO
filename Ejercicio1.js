...
function pedirNumero1(rl, mensaje) {
    return __awaiter(this, void 0, void 0, function () {
        var input_2, numero;
        return __generator(this, function (_a) {
            switch (_a.label) {
                        ...
                        return __generator(this, function (_q) {
                            switch (_q.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, pedirNumero1(rl, "Ingrese el precio del inmobiliario: ")];
                                case 1:
                                    eleccion = _q.sent();
                                    if (eleccion === 0) {
                                ...
                                case 11:
                                    ...
                                    return [4 /*yield*/, pedirNumero(rl, "Ingrese el numero de pisos: ")];
                                case 12:
                                    pisos = _q.sent();
                                    return [4 /*yield*/, pedirNumero(rl, "Ingrese el numero de habitaciones: ")];
                                case 13:
                                    habitaciones = _q.sent();
                                    return [4 /*yield*/, pedirNumero(rl, "Ingrese el numero de baños: ")];
                                case 14:
                                    bath = _q.sent();
                                ...
                                case 20:
                                    ...
                                    return [4 /*yield*/, pedirNumero(rl, "Ingrese el numero correspondiente: ")];
                                case 21:
                                    tipoEditar = _q.sent();
                                    arrayEditar = null;
                                    nombreEditar = "";
                                    ...
                                    arrayEditar.forEach(function (prop) {
                                        console.log("ID: ".concat(prop.id, " - Direccion: ").concat(prop.direccion, " - Precio: ").concat(prop.precio));
                                    });
                                ...
                                case 34:
                                    ...
                                    _j = propiedad;
                                    return [4 /*yield*/, pedirNumero(rl, "Ingrese el nuevo numero de habitaciones: ")];
                                case 35:
                                ...
                                case 37:
                                    ...
                                    _k = propiedad;
                                    return [4 /*yield*/, pedirNumero(rl, "Ingrese el nuevo numero de baños: ")];
                                case 38:
                                    _k.bath = _q.sent();
                                    _q.label = 39;
                                ...
                                case 40:
                                    ...
                                    _l = propiedad;
                                    return [4 /*yield*/, pedirNumero(rl, "Ingrese el nuevo numero de pisos: ")];
                                case 41:
                                    _l.pisos = _q.sent();
                                    return [3 /*break*/, 44];
                                case 42:
                                ...
                                case 47:
                                    ...
                                    _o = parseInt;
                                    return [4 /*yield*/, rl.question("Ingrese el numero correspondiente: ")];
                                case 48:
                                    ...
                                    arraySeleccionado.forEach(function (prop, index) {
                                        console.log("=> ID: ".concat(prop.id, " \nDireccion: ").concat(prop.direccion, " - Precio: ").concat(prop.precio));
                                    });
                                    _p = parseInt;
